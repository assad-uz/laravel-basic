...
<html
  ...
  data-assets-path="admin-src/assets/"
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{asset('admin-src/assets/img/favicon/favicon.ico')}}" />
    ...
    <link rel="stylesheet" href="{{asset('admin-src/assets/vendor/fonts/iconify-icons.css')}}" />

    <!-- Core CSS -->
    <!-- build:css assets/vendor/css/theme.css  -->
    
    <link rel="stylesheet" href="{{asset('admin-src/assets/vendor/css/core.css')}}" />
    <link rel="stylesheet" href="{{asset('admin-src/assets/css/demo.css')}}" />

    <!-- Vendors CSS -->

    <link rel="stylesheet" href="{{asset('admin-src/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css')}}" />
    ...
    <script src="{{asset('admin-src/assets/js/config.js')}}"></script>
  </head>
  ...
  <body>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a
                    ...
                    <div class="avatar avatar-online">
                      <img src="{{asset('admin-src/assets/img/avatars/1.png')}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                          <div class="d-flex mb-6">
                            <div class="avatar flex-shrink-0 me-3">
                              <img src="{{asset('admin-src/assets/img/icons/unicons/wallet.png')}}" alt="User" />
                            </div>
                            <div>
                    ...
                    <div class="card-body pt-4">
                      <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{asset('admin-src/assets/img/icons/unicons/paypal.png')}}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{asset('admin-src/assets/img/icons/unicons/wallet.png')}}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{asset('admin-src/assets/img/icons/unicons/chart.png')}}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center mb-6">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{asset('admin-src/assets/img/icons/unicons/cc-primary.png')}}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                        ...
                        <li class="d-flex align-items-center">
                          <div class="avatar flex-shrink-0 me-3">
                            <img src="{{asset('admin-src/assets/img/icons/unicons/cc-warning.png')}}" alt="User" class="rounded" />
                          </div>
                          <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
    ...
    <script src="{{asset('admin-src/assets/vendor/libs/jquery/jquery.js')}}"></script>

    <script src="{{asset('admin-src/assets/vendor/libs/popper/popper.js')}}"></script>
    <script src="{{asset('admin-src/assets/vendor/js/bootstrap.js')}}"></script>

    <script src="{{asset('admin-src/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js')}}"></script>

    <script src="{{asset('admin-src/assets/vendor/js/menu.js')}}"></script>

    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{asset('admin-src/assets/vendor/libs/apex-charts/apexcharts.js')}}"></script>

    <!-- Main JS -->

    <script src="{{asset('admin-src/assets/js/main.js')}}"></script>

    <!-- Page JS -->
    <script src="{{asset('admin-src/assets/js/dashboards-analytics.js')}}"></script>
